INSERT INTO applicant(id, first_name, last_name, email, phone) values (200, 'First', 'Last', 'first.last@email.com', '1234567890');
INSERT INTO application(id, property_id, applicant_id, status) values (100, 1, 200, 'PENDING_APPROVAL');
...
values (300, 200, 1, 1, 'JANUARY', 2000, 'MARCH', 2010, 1500.00, 'Landord Name', 'landlord@email.com', '4561237890');