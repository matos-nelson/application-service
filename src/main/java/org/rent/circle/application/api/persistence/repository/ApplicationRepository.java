...
public class ApplicationRepository implements PanacheRepository<Application> {
    ...
    public Application findApplication(Long id, String managerId) {
    ...
    public List<Application> findApplications(String managerId, int page, int pageSize) {
        return find("managerId", managerId)
            .page(Page.of(page, pageSize))
            .list();
    }

    public Application findApplicantsPendingApplication(String managerId, String email) {
