...
You can then execute your native executable with: `./target/application-service-1.0.0-runner`
...
```shell script
docker build -f src/main/docker/Dockerfile.native-micro -t quarkus/application-service .
```
